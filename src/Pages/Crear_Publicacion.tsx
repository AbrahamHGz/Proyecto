    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (error.response && error.response.data && error.response.data.error) {
                ...
                alert("Error inesperado al crear la publicación");  // Fallback si el error no tiene mensaje específico
            }
        }
    };
                ...
                <div className="mt-2 p-4 rounded md:mx-20 md:bg-gray-400">
                    ...
                    <form onSubmit={handleSubmit} className="grid xl:grid-cols-3 my-2">
                        ...
                        <ol className="">
                            ...
                            <li className="mt-4">
                                <input type="submit" value="Publicar" className="mb-2 text-white font-bold  bg-slate-800 px-4 p-2 rounded hover:bg-slate-700  md:w-96 w-full p-1" />
                            </li>
                        </ol>
