...
const Perfil: React.FC = () => {
  ...
  useEffect(() => {
    if (!usuario && seccionActiva !== "AcercadeMi") {
      setSeccionActiva("AcercadeMi");
    }
  ...
  const handleSubmitSeguir = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.response?.data?.error) {
        ...
        console.log("Error inesperado al intentar seguir");
      }
    }
  };
  ...
  const handleBorrarSeguir = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.response?.data?.error) {
        ...
        console.log("Error inesperado al dejar de seguir");
      }
    }
  };
    ...
    <>
      ...
      <div className="lg:mx-40 md:mx-20 space-x-2">
        ...
        <button
          ...
          disabled={!usuario}
          className={`font-bold lg:px-10 p-1 rounded-t text-white ${
            !usuario 
