        ...
        <div className="mx-40 bg-red-50 rounded-lg p-6 mt-10 shadow-inner flex items-start space-x-4">
            ...
            <div>
                ...
                <p className="text-red-700 mb-4">
                    Ha ocurrido un error. Esta Publicación no cuenta con "Categorías". No se puede visualizar.
                </p>
                ...
                <div className="flex gap-4">
                    ...
                    {userId === pubUsuarioId && (
                        <Link 
                            to={`/Editar publicacion/${pubId}`}
                            className="inline-block px-6 py-2 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-lg transition">
