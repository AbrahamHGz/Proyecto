        ...
        <>
            <div className="bg-slate-950 p-4 fixed w-full flex items-center grid grid-cols-2">
                    ...
                    <div className="flex text-white space-x-2 justify-end">
                        <Link to="/Login" className="border p-2 hover:bg-slate-700 rounded">Iniciar Sesión</Link>
                        <Link to="/Singup" className="border p-2 hover:bg-slate-700 rounded">Registrarse</Link>
                    </div>
            </div>
        </>
    )
